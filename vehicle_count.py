...
middle_line_position = 175
up_line_position = middle_line_position - 55
down_line_position = middle_line_position + 45
...
def realTime():
    while True:
        ...
        blob = cv2.dnn.blobFromImage(img, 1 / 225, (input_size, input_size), [0, 0, 0], 1, crop=False)
